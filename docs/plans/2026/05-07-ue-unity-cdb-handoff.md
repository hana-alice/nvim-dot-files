...
4. ✅ 已做: 更新 skill `ue-kurofork-force-unity-cdb-via-cli` 的 Pitfall 3b
   (旧正则 `^[^/]+/[^/]+/[^/]+/([^/]+)/Module%.[^/]+%.cpp$` 强锁三段，
...
skill 文件: `<LOCAL_APPDATA>\hermes\skills\software-development\ue-kurofork-force-unity-cdb-via-cli\SKILL.md`
...
skill:
  <LOCAL_APPDATA>\hermes\skills\software-development\ue-kurofork-force-unity-cdb-via-cli\SKILL.md
