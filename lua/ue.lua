...
local function resolve_project_input(path, engine_root)
  ...
  if path:match("^[A-Za-z]:[^\\/]") then
    return nil, nil,
      ...
      " (missing slash after drive letter, e.g. use 'E:/Projects/...' not 'E:aki/...')"
  end
    ...
    if code_search_p.cindex_uefilter_exe() then
      ...
      if fout then
        for _, rel in ipairs(workspace_all) do
          ...
          -- garbage like "D:/UE/EngineWorktree/E:/Projects/...", which os.Stat rejects
...
function M.setup()
  ...
  vim.api.nvim_create_autocmd("BufEnter", {
    ...
    callback = function()
      ...
      -- E:/Projects/A but the file lives in E:/Projects/B) is never auto-switched.
