  ...
  -- ── Tab 6: Tools ──
  {
    ...
    sections = {
      ...
      },
      {
        ...
        mappings = {
          { "]h / [h",        "Next / prev hunk" },
          { "<leader>gb",     "Blame current line (LazyVim)" },
          { "<leader>gB",     "Blame full buffer (LazyVim)" },
          { "<leader>gd",     "Preview diff hunk (LazyVim)" },
          { "<leader>uG",     "Toggle git signs" },
        },
      },
      {
        title = "Git — VSCode-style 3 views (diffview)",
        mappings = {
          { "<leader>gv",     "Working tree changes (left panel)" },
          { "<leader>gV",     "Close diffview" },
          { "<leader>gm",     "This file history" },
          { "<leader>gM",     "Branch history → pick commit → see files" },
          { "<leader>gv (v)", "Selected lines history (visual mode)" },
        },
      },
      {
      ...
      {
        title = "Git — Pickers & Ops",
        mappings = {
          { "<leader>gs",     "Status picker (snacks)" },
          { "<leader>gc",     "Commits picker (snacks)" },
          { "<leader>fg",     "Git files (UE-aware)" },
          { "<leader>gn",     "Neogit (commit / push / pull / stash / branch)" },
          { "  in Neogit:",   "s stage  u unstage  x discard  c commit" },
          { "  in Neogit:",   "P push  p pull  b branch  Z stash  l log" },
        },
      },
    },
  },
