    ...
    sections = {
      ...
      },
      {
        ...
        mappings = {
          ...
          { "<leader>gvf/gvb","Diffview file / branch history" },
          { "<leader>gvc/gvm","Diffview last commit / vs origin" },
          { "]c / [c (in diff)", "Next/prev hunk in current file" },
          { "]h / [h (in diff)", "Next/prev hunk (cross file)" },
          { "]x / [x (in diff)", "Next/prev merge conflict" },
          { "<tab>/<s-tab> (diff)", "Next/prev file" },
          { "<leader>gB/gY",  "Browse / copy URL" },
          { "<leader>gn/gN",  "Neogit status (split / tab)" },
          { "<leader>gnc/gnp/gnP", "Neogit commit / pull / push" },
          { "<leader>gnl/gnb/gns", "Neogit log / branch / stash" },
        },
      },
    },
  },
