# lua/utils/platform/ — GPT/Codex pointer
...
> marks this as the only place allowed to branch on OS; the "Claude Code" wording
> is historical and applies to you (GPT/Codex) too.
>
