...
PATTERNS=(
  "company-email|lizeqiang@samplegame\.com"
  "company-domain|samplegame\.com"
  "sample-gitlab|git\.sample\.com"
  "project-codename-SampleGame|\bSampleGame\b"
  "project-appid-SampleGame|com\.samplegame\.SampleGame"
