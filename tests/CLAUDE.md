...
> 继承 `../CLAUDE.md`（根强制入口）。本目录承载「改动后回归」纪律的**速查映射**。
> 权威操作细节在 `../docs/testing-regression.md`；完成的硬标准在根 `CLAUDE.md` DoD。
...
`../docs/testing-regression.md`（权威）、根 `CLAUDE.md` 的 Definition of Done。
