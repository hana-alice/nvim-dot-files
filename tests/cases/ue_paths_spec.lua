...
t.describe("ue_paths: is_blocked", function()
  ...
  t.it("OMX experiment copies are noise without matching similarly named source paths", function()
    t.assert_true(up.is_blocked("/proj/.omx/artifacts/SourceCopy.cpp"))
    t.assert_true(up.is_blocked("C:\\proj\\.OMX\\artifacts\\Copy.h"))
    t.assert_false(up.is_blocked("/proj/Source/omx/Real.cpp"))
    t.assert_false(up.is_blocked("/proj/Source/.omx-compatible/Real.h"))
  end)
end)
